...
data modify storage global_shop:storage g_lang."common.have_run_new_version" set value "这个游戏存档运行过更高版本的全球商店, 版本号为"
data modify storage global_shop:storage g_lang."common.have_run_old_version" set value "这个游戏存档运行过更低版本的全球商店, 版本号为"
...
data modify storage global_shop:storage g_lang."common.view_selling" set value "查看自己正在出售的物品"
...
data modify storage global_shop:storage g_lang."tip_stop.7" set from storage global_shop:storage g_lang."common.click_to_boot"
...
data modify storage global_shop:storage g_lang."error.wrong_version.newer.1" set from storage global_shop:storage g_lang."common.have_run_new_version"
data modify storage global_shop:storage g_lang."error.wrong_version.newer.2" set from storage global_shop:storage g_lang."common.current_version_is"
data modify storage global_shop:storage g_lang."error.wrong_version.newer.3" set from storage global_shop:storage g_lang."common.replace_correct_version"
data modify storage global_shop:storage g_lang."error.wrong_version.older.1" set from storage global_shop:storage g_lang."common.have_run_old_version"
data modify storage global_shop:storage g_lang."error.wrong_version.older.2" set from storage global_shop:storage g_lang."common.current_version_is"
data modify storage global_shop:storage g_lang."error.wrong_version.older.3" set from storage global_shop:storage g_lang."common.replace_correct_version"
data modify storage global_shop:storage g_lang."boot.set_admin" set value "已将你设置为商店管理员"
data modify storage global_shop:storage g_lang."boot.wrong_version.newer.1" set from storage global_shop:storage g_lang."common.shop_boot_fail"
data modify storage global_shop:storage g_lang."boot.wrong_version.newer.2" set from storage global_shop:storage g_lang."common.have_run_new_version"
data modify storage global_shop:storage g_lang."boot.wrong_version.newer.3" set from storage global_shop:storage g_lang."common.current_version_is"
data modify storage global_shop:storage g_lang."boot.wrong_version.newer.4" set from storage global_shop:storage g_lang."common.replace_correct_version"
data modify storage global_shop:storage g_lang."boot.wrong_version.older.1" set from storage global_shop:storage g_lang."common.shop_boot_fail"
data modify storage global_shop:storage g_lang."boot.wrong_version.older.2" set from storage global_shop:storage g_lang."common.have_run_old_version"
data modify storage global_shop:storage g_lang."boot.wrong_version.older.3" set from storage global_shop:storage g_lang."common.current_version_is"
data modify storage global_shop:storage g_lang."boot.wrong_version.older.4" set from storage global_shop:storage g_lang."common.replace_correct_version"
...
data modify storage global_shop:storage g_lang."admin_settings.reset_dynamic_data_tip.1" set value "你需要按照以下步骤来抹除动态数据"
...
data modify storage global_shop:storage g_lang."admin_settings.reset_dynamic_data_tip.5" set value "然后点击这里来停止运行并抹除动态数据"
...
data modify storage global_shop:storage g_lang."edit_main.install_tip.2" set value "你需要按照以下步骤抹除所有数据并卸载"
...
data modify storage global_shop:storage g_lang."player_shop.jump_order.negative" set from storage global_shop:storage g_lang."common.input_negative"
data modify storage global_shop:storage g_lang."player_shop.jump_id.already" set value "你已经在看这个 id 的物品, 无需跳转"
data modify storage global_shop:storage g_lang."player_shop.jump_id.negative" set from storage global_shop:storage g_lang."common.input_negative"
...
data modify storage global_shop:storage g_lang."change_mode.view_selling" set from storage global_shop:storage g_lang."common.view_selling"
...
data modify storage global_shop:storage g_lang."change_mode.cash" set from storage global_shop:storage g_lang."common.save_draw_money"
...
data modify storage global_shop:storage g_lang."control.enter_cash" set from storage global_shop:storage g_lang."common.save_draw_money"
...
data modify storage global_shop:storage g_lang."control.player_shop_main.enter_view_selling" set from storage global_shop:storage g_lang."common.view_selling"
...
data modify storage global_shop:storage g_lang."control.edit_cash.disabled" set from storage global_shop:storage g_lang."common.cash_disabled"
...
data modify storage global_shop:storage g_lang."item_frame.cash_value" set value "货币价值"
