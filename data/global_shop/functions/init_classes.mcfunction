...
tellraw @a [{"type":"nbt","storage":"global_shop:storage","nbt":"TELLRAW_PREFIX","interpret":true},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"ask_boot.1\"","color":"green"},"\n",{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"ask_boot.2\"","color":"yellow","clickEvent":{"action":"run_command","value":"/function global_shop:settings/try_boot"},"underlined":true,"hoverEvent":{"action":"show_text","contents":[{"text":"(","color":"gray"},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"ask_boot.3\"","color":"gray"},{"text":"^_^)","color":"gray"},"\n",{"text":"1. ","color":"green"},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"ask_boot.4\"","color":"green"},"\n",{"text":"2. ","color":"green"},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"ask_boot.5\"","color":"green"}]},"bold":true}]
