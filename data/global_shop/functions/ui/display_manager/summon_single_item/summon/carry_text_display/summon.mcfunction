...
# shadow 文本是否显示阴影
data merge entity @s {Tags:["global_shop"],transformation:{translation:[0.22f,0.0f,-3.8f],scale:[1.1f,1.1f,1.1f]},billboard:"fixed",alignment:"right",text_opacity:4b,background:0b,brightness:{block:15,sky:15},shadow:true}
