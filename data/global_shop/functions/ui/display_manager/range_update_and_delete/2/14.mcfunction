...
execute store result score temp2 glbs_common run data get storage global_shop:common g_itemsToDisplay[14].tag.global_shop.id
...
#data modify entity @s item.Count set from storage global_shop:common g_itemsToDisplay[14].Count
