...
scoreboard objectives add global_shop dummy
# 类初始化操作，仅调用一次
execute unless score g_isInit global_shop matches 1 run function global_shop:init_classes
scoreboard players set g_isInit global_shop 1
