...
# 设置成功
tellraw @s [{"text":"成功将商店的语言从 ","color":"green"},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.lang","color":"yellow"},{"text":" 设置为 ","color":"green"},{"type":"nbt","storage":"global_shop:common","nbt":"temp.input","color":"yellow"}]
