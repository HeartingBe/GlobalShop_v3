...
execute unless score temp glbs_common matches 1 run tellraw @s [{"type":"nbt","storage":"global_shop:storage","nbt":"TELLRAW_PREFIX","interpret":true},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"admin_settings.lang.fail.1\"","color":"red"}," ",{"type":"nbt","storage":"global_shop:common","nbt":"temp.input","color":"yellow"},"\n",{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"admin_settings.lang.fail.2\"","color":"red"}]
execute unless score temp glbs_common matches 1 run return run function global_shop:sound/fail

# 设置成功
tellraw @s [{"type":"nbt","storage":"global_shop:storage","nbt":"TELLRAW_PREFIX","interpret":true},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"admin_settings.lang.set_success.1\"","color":"green"}," ",{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"lang\"","color":"yellow"},"\n",{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"admin_settings.lang.set_success.2\"","color":"green"}," ",{"type":"nbt","storage":"global_shop:common","nbt":"temp.input","color":"yellow"}]
