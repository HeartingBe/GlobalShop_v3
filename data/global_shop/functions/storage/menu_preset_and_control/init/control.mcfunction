...
# region 玩家商店主菜单
    ...
    #浏览玩家物品
    data modify storage global_shop:menu_preset_and_control CONTROL_VIEW_PLAYER_SHOP set value {id:"minecraft:ender_chest",Count:1b,tag:{global_shop:{text:[{"storage":"global_shop:storage","nbt":"TEXT_PREFIX_SIMPLE","interpret":1},{"text":"浏览玩家商店","color":"yellow"},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"text":"● ","color":"white"},{"text":"输入以下命令：","color":"aqua"},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"text":"  /trigger glbs_inputter_1 set ","color":"white"},{"text":"?  ","color":"yellow"},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"text":"  跳转到第 ","color":"green"},{"text":"?","color":"yellow"},{"text":" 个物品开始浏览","color":"green"},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"text":"● ","color":"white"},{"text":"输入以下命令：","color":"aqua"},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"text":"  /trigger glbs_inputter_2 set ","color":"white"},{"text":"?  ","color":"yellow"},{"storage":"global_shop:storage","nbt":"SEPERATOR","interpret":1},{"text":"  寻找编号为 ","color":"green"},{"text":"?","color":"yellow"},{"text":" 的物品","color":"green"}]}}}
