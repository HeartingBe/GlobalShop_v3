...
# region 货币设置页面
    ...
    #重置货币
    data modify storage global_shop:menu_preset_and_control CONTROL_RESET_CASH set value {id:"minecraft:grindstone",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.1\"","color":"red"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.2\"","color":"red","bold":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.3\"","color":"green"}]}}}
