...
# region 主菜单
    #欢迎
    data modify storage global_shop:menu_preset_and_control CONTROL_WELCOME set value {id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Name:"Alumopper_"},global_shop:{text:[{"text":"Welcome to GlobalShop!","color":"yellow","bold":1}]}}}
    execute store result storage global_shop:menu_preset_and_control CONTROL_WELCOME.tag.global_shop.id int 1 run scoreboard players get CONTROL_WELCOME glbs_common
    execute store result storage global_shop:menu_preset_and_control CONTROL_WELCOME.tag.global_shop.type int 1 run scoreboard players get ItemDataType::CONTROL glbs_common

    #包信息
    data modify storage global_shop:menu_preset_and_control CONTROL_DATAPACK_INFO set value {id:"minecraft:writable_book",Count:1b,tag:{global_shop:{text:[{"text":"Alumopper_","color":"yellow"},{"text":" x ","color":"white"},{"text":"Mini_Ye","color":"yellow"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"text":"Click to get more information^_^","color":"green"}]}}}
    ...
    #进入玩家商店主界面
    data modify storage global_shop:menu_preset_and_control CONTROL_ENTER_PLAYER_SHOP_MAIN set value {id:"minecraft:light_blue_shulker_box",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.enter_player_shop_main\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #进入编辑模式
    data modify storage global_shop:menu_preset_and_control CONTROL_ENTER_EDIT set value {id:"minecraft:diamond_pickaxe",tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.enter_edit.1\"","color":"aqua"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.enter_edit.2\"","color":"red"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b},Count:1b}
    ...
    #浏览出售商店
    data modify storage global_shop:menu_preset_and_control CONTROL_ENTER_SELL_SHOP set value {id:"minecraft:barrel",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.enter_sell_shop\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #进入金钱物品兑换界面
    data modify storage global_shop:menu_preset_and_control CONTROL_CASH_EXCHANGE set value {id:"minecraft:paper",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.enter_cash\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #浏览回收商店
    data modify storage global_shop:menu_preset_and_control CONTROL_ENTER_RECYCLE_SHOP set value {id:"minecraft:composter",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.enter_recycle_shop\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #玩家个人设置
    data modify storage global_shop:menu_preset_and_control CONTROL_PLAYER_SETTINGS set value {id:"minecraft:iron_pickaxe",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.enter_player_settings\"","color":"aqua"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
...
# region 玩家商店主菜单
    ...
    #浏览玩家商店
    data modify storage global_shop:menu_preset_and_control CONTROL_VIEW_PLAYER_SHOP set value {id:"minecraft:barrel",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_player_shop.1\"","color":"yellow"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"text":"  "},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_player_shop.2\"","color":"aqua"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"text":"● ","color":"white"},{"text":"/trigger glbs_inputter_1 set ","color":"white"},{"text":"?","color":"yellow"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"text":"  "},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_player_shop.3\"","color":"green"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"text":"● ","color":"white"},{"text":"/trigger glbs_inputter_2 set ","color":"white"},{"text":"?","color":"yellow"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"text":"  "},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_player_shop.4\"","color":"green"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #浏览正在出售的物品
    data modify storage global_shop:menu_preset_and_control CONTROL_VIEW_MY_SELLING set value {id:"minecraft:orange_shulker_box",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_view_selling\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #浏览退回的物品
    data modify storage global_shop:menu_preset_and_control CONTROL_VIEW_RETURN_ITEMS set value {id:"minecraft:composter",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_view_return\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #浏览历史购买物品
    data modify storage global_shop:menu_preset_and_control CONTROL_VIEW_MY_BOUGHT set value {id:"minecraft:ender_pearl",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_view_bought\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
    ...
    #浏览历史出售物品
    data modify storage global_shop:menu_preset_and_control CONTROL_VIEW_MY_SOLD set value {id:"minecraft:ender_eye",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.player_shop_main.enter_view_sold\"","color":"yellow"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
...
# region 编辑模式菜单
    ...
    #进入管理员全局设置页面
    data modify storage global_shop:menu_preset_and_control CONTROL_SETTING_PAGE set value {id:"minecraft:netherite_pickaxe",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_main.enter_admin_settings\"","color":"gold"}]},Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:1b}}
...
# region 货币设置页面
    ...
    #重置货币
    data modify storage global_shop:menu_preset_and_control CONTROL_RESET_CASH set value {id:"minecraft:grindstone",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.1\"","color":"red"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.2\"","color":"red","bold":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.3\"","color":"green"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.4\"","color":"green"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.edit_cash.reset_all.5\"","color":"green"}]}}}
...
# region 货币兑换页面
    #存钱
    data modify storage global_shop:menu_preset_and_control CONTROL_DEPOSIT_CASH set value {id:"minecraft:chest",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.cash.save_money\"","color":"gold"}]}}}
