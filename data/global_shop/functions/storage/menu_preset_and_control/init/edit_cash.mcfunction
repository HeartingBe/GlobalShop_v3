...
data modify storage global_shop:menu_preset_and_control DEFAULT_CASH_INFO[].item.tag.display.Name set from storage global_shop:menu_preset_and_control DEFAULT_CASH_NAME
