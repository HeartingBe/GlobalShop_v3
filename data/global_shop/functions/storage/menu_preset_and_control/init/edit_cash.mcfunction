...
data modify storage global_shop:menu_preset_and_control DEFAULT_CASH_INFO set value [{item:{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.control.cash","interpret":true}'},global_shop:{price:1},Enchantments:[{id:"minecraft:unbreaking",lvl:1}]}},price:1},{item:{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.control.cash","interpret":true}'},global_shop:{price:5},Enchantments:[{id:"minecraft:unbreaking",lvl:1}]}},price:5},{item:{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.control.cash","interpret":true}'},global_shop:{price:10},Enchantments:[{id:"minecraft:unbreaking",lvl:1}]}}},{item:{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.control.cash","interpret":true}'},global_shop:{price:50},Enchantments:[{id:"minecraft:unbreaking",lvl:1}]}}},{item:{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.control.cash","interpret":true}'},global_shop:{price:100},Enchantments:[{id:"minecraft:unbreaking",lvl:1}]}}}]
