...
# 物品信息框大小
    # 调整物品信息框大小
    data modify storage global_shop:storage g_playerSettingList prepend value {id:"minecraft:item_frame",Count:1b,tag:{global_shop:{text:[{"text":"调整物品信息框大小","color":"yellow"}]}}}
    ...
    # 恢复默认物品信息框大小
    data modify storage global_shop:storage g_playerSettingList prepend value {id:"minecraft:item_frame",Count:1b,tag:{global_shop:{text:[{"text":"恢复默认物品信息框大小","color":"yellow"}]}}}
...
# 物品信息框位置
    # 调整物品信息框上下位置
    data modify storage global_shop:storage g_playerSettingList prepend value {id:"minecraft:glow_item_frame",Count:1b,tag:{global_shop:{text:[{"text":"调整物品信息框上下位置","color":"yellow"}]}}}
    ...
    execute store result storage global_shop:storage g_playerSettingList[0].tag.global_shop.type int 1 run scoreboard players get ItemDataType::SETTING glbs_common
    # 调整物品信息框左右位置
    data modify storage global_shop:storage g_playerSettingList prepend value {id:"minecraft:glow_item_frame",Count:1b,tag:{global_shop:{text:[{"text":"调整物品信息框左右位置","color":"yellow"}]}}}
    ...
    execute store result storage global_shop:storage g_playerSettingList[0].tag.global_shop.type int 1 run scoreboard players get ItemDataType::SETTING glbs_common
    # 调整物品信息框前后位置
    data modify storage global_shop:storage g_playerSettingList prepend value {id:"minecraft:glow_item_frame",Count:1b,tag:{global_shop:{text:[{"text":"调整物品信息框前后位置","color":"yellow"}]}}}
    ...
    execute store result storage global_shop:storage g_playerSettingList[0].tag.global_shop.type int 1 run scoreboard players get ItemDataType::SETTING glbs_common
    # 恢复默认物品信息框位置
    data modify storage global_shop:storage g_playerSettingList prepend value {id:"minecraft:glow_item_frame",Count:1b,tag:{global_shop:{text:[{"text":"恢复默认物品信息框位置","color":"yellow"}]}}}
