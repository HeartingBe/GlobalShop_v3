...
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_NULL_ITEM
# 10
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_ENTER_PLAYER_SHOP_MAIN
# 11 
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_NULL_ITEM
# 12
...
# 14
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_MONEY_ITEM_EXCHANGE
# 15
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_NULL_ITEM
# 16
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_ENTER_RECYCLE_SHOP
# 17~26
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_NULL_ITEM
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_NULL_ITEM
data modify storage global_shop:menu_preset_and_control main append from storage global_shop:menu_preset_and_control CONTROL_NULL_ITEM
