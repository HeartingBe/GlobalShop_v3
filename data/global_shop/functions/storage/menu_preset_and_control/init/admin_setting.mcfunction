...
data modify storage global_shop:storage g_adminSettingList prepend value {id:"minecraft:grindstone",Count:1b,tag:{global_shop:{text:[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.admin_settings.reset_dynamic_data.1\"","color":"red"},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"storage":"global_shop:storage","nbt":"char.SEPERATOR","interpret":1},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"control.admin_settings.reset_dynamic_data.2\"","color":"red"},{"text":": ","color":"red"}]}}}
