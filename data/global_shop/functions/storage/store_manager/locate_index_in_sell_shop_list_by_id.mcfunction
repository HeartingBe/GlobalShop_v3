#> global_shop:storage/store_manager/locate_index_in_sell_shop_list_by_id
#
# 根据 id 在 g_sellShopList 中定位该物品的下标
# @param id 要查找的物品
...
# while
execute if score left glbs_common <= right glbs_common run function global_shop:storage/store_manager/locate_index_in_sell_shop_list_by_id/while
