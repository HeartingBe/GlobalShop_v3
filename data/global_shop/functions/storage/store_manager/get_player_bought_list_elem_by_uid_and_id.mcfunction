#> global_shop:storage/store_manager/get_player_bought_list_elem_by_uid_and_id
# @brief 获取 g_playerBoughtListMap.<uid>[{id:<id>}]
# @param uid 要获取的历史购买记录所属的这个玩家的 uid
# @param g_itemData 出参
# @executor Menu
...
function global_shop:storage/store_manager/get_player_bought_list_elem_by_uid_and_id/macro_get_elem with storage global_shop:common temp