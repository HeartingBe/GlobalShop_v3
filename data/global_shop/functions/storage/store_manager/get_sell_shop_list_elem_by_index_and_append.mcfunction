# @brief 获取 g_sellShopList[index] 并将其尾插到 g_itemsToDisplay
...
execute store result score temp3 glbs_common run data get storage global_shop:storage g_sellShopList
...
function global_shop:storage/store_manager/get_sell_shop_list_elem_by_index_and_append/1 with storage global_shop:common temp