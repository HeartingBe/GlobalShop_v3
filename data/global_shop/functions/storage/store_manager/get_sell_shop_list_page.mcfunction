#> global_shop:storage/store_manager/get_sell_shop_list_page
#
...
execute store result score temp1 glbs_common run data get storage global_shop:storage g_sellShopList
...
function global_shop:storage/store_manager/get_sell_shop_list_page/1