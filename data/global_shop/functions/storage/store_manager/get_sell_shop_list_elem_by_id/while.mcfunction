...
execute store result score tempId glbs_common run function global_shop:storage/store_manager/get_sell_shop_list_elem_by_id/macro_get_id with storage global_shop:common temp

# if
execute if score id glbs_common > tempId glbs_common run return run function global_shop:storage/store_manager/get_sell_shop_list_elem_by_id/while/if
# else if
execute if score id glbs_common < tempId glbs_common run return run function global_shop:storage/store_manager/get_sell_shop_list_elem_by_id/while/else_if
# else 取 index = mid 返回
