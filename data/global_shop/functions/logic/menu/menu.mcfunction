...
execute if score g_connectNum glbs_common >= MAX_CONNECT_NUM glbs_common unless score @s glbs_permission = Permission::ADMIN glbs_common run return run tellraw @s ["\u00a7c同时使用商店人数已达上限, 请稍后使用"]
