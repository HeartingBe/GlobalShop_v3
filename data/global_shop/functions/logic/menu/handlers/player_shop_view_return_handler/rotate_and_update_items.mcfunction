#> global_shop:logic/menu/handlers/player_shop_view_return_handler/rotate_and_update_items
...
# 取玩家退回的物品数据
function global_shop:storage/store_manager/get_player_shop_return_list_page
...
# if (g_columnDiff < 0)
   execute if score g_columnDiff glbs_common matches ..-1 run return run function global_shop:logic/menu/handlers/rotatable_menu_handler/rotate_and_update_items/1
# else
