...
# 判断玩家出售物品
execute on passengers if entity @s[type=minecraft:player] unless score @s glbs_sell_item_price matches 0 run function global_shop:logic/menu/handlers/player_shop_main_menu_handler/handle/player_sell_item
...
# 判断玩家左键
   ...
   execute if score temp glbs_common = Action::LEFT_CLICK glbs_common run function global_shop:logic/menu/handlers/player_shop_main_menu_handler/handle/player_left_click