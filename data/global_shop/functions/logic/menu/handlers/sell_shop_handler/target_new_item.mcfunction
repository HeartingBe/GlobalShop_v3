...
# 高亮物品展示实体，并显示文本
   ...
   execute if score @s glbs_last_action_target_id matches -1 run return run function global_shop:logic/menu/handlers/sell_shop_handler/handle/item_not_exist
