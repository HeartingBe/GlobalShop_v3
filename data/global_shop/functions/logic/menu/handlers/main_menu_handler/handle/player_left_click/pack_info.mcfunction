...
#tellraw @s [{"text":"■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■"}]
#tellraw @s [{"text":"                   GlobalShop v3.0                   "}]
#tellraw @s [{"text":"   https://github.com/HeartingBe/GlobalShop_v3.git   "}]
#tellraw @s [{"text":"                                                     "}]
#tellraw @s [{"text":"                     Developers                      "}]
#tellraw @s [{"text":"              >>>    Alumopper_                      "}]
#tellraw @s [{"text":"              >>>     Mini_Ye                        "}]
#tellraw @s [{"text":"                                                     "}]
#tellraw @s [{"text":"   Works on Minecraft JE 1.20.3                      "}]
#tellraw @s [{"text":"■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■"}]

tellraw @s [{"text":"■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■","color":"#e7e7e7"}]
tellraw @s ["                  ",{"text":"GlobalShop v3.0","color":"#00f178","bold":true}]
...
tellraw @s ["              ",{"text":">>>","color":"gray"},"     ",{"text":"Alumopper_","clickEvent":{"action":"open_url","value":"https://alumopper.top/"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to access snow fox nest qwq","color":"#ff78e8"}]},"color":"#ff78e8"}]
