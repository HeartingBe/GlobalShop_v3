...
# 移除这个物品
function global_shop:storage/store_manager/delete_recycle_shop_elem_by_id
...
# 通知玩家
execute on passengers if entity @s[type=minecraft:player] run tellraw @s ["\u00a7a成功删除该回收商店物品"]