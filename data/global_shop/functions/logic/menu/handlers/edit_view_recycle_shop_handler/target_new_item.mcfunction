...
# 高亮物品展示实体，并显示文本
   ...
   execute on passengers if entity @s[type=minecraft:item_display,tag=!glbs_killed] run function global_shop:logic/menu/handlers/edit_view_recycle_shop_handler/highlight_item_and_display_text
   ...
   execute if score @s glbs_last_view_id matches -1 run return run function global_shop:logic/menu/handlers/edit_view_recycle_shop_handler/handle/item_not_exist
