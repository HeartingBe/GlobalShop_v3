...
# 判断玩家看向新的物品实体
   ...
   execute unless score temp glbs_common = @s glbs_last_view_order run return run function global_shop:logic/menu/handlers/player_shop_handler/target_new_item
