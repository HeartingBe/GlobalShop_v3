...
# 物品变红色提示玩家即将删除该物品
execute on passengers if entity @s[type=minecraft:item_display,tag=!glbs_killed] if score @s glbs_order = temp glbs_common run function global_shop:logic/item_display_entity/set_state_will_delete
