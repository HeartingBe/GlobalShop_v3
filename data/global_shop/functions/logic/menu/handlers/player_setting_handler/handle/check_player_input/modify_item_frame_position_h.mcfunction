...
tellraw @s [{"text":"成功调整物品信息框左右位置","color":"green"}]

function global_shop:sound/success

# 溢出提示
execute unless score @s glbs_st_item_frame_pos_h matches -49..49 run tellraw @s [{"text":"物品信息框左右位置变化的范围是","color":"red"},{"text":": [-50, 50]","color":"red"},"\n",{"text":"当前你设置的左右位置变化是:","color":"red"}," ",{"score":{"objective":"glbs_st_item_frame_pos_h","name":"@s"},"color":"yellow"},"\n",{"text":"之后将无法再往溢出方向继续调整","color":"red"}]
