...
# 溢出提示
execute unless score @s glbs_st_item_frame_pos_d matches -49..49 run tellraw @s [{"type":"nbt","storage":"global_shop:storage","nbt":"\"g_lang.player_settings.info_frame.pos_d.overflow.1\"","color":"red"},{"text":": [-50, 50]","color":"red"},"\n",{"type":"nbt","storage":"global_shop:storage","nbt":"\"g_lang.player_settings.info_frame.pos_d.overflow.2\"","color":"red"}," ",{"score":{"objective":"glbs_st_item_frame_pos_d","name":"@s"},"color":"yellow"},"\n",{"type":"nbt","storage":"global_shop:storage","nbt":"\"g_lang.player_settings.info_frame.pos_d.overflow.3\"","color":"red"}]
