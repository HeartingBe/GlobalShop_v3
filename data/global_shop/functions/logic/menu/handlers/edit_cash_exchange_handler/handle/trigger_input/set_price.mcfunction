...
execute if score last_chosen_cash_index glbs_common matches 4 run function global_shop:logic/menu/handlers/edit_cash_exchange_handler/handle/trigger_input/set_price/4