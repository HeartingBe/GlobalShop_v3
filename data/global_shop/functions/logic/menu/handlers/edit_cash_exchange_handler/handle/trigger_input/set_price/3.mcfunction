...
execute if score targetOrder glbs_common matches 16 on vehicle on passengers if entity @s[scores={glbs_order=16},type=minecraft:item_display,tag=!glbs_killed,tag=glbs_item_highlight] run function global_shop:logic/item_display_entity/flush_display_text
