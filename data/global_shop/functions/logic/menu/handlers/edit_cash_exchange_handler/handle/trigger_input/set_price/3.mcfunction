...
# 如果物品高亮，重置状态重新展示文本
execute on vehicle on passengers if entity @s[scores={glbs_order=16},type=minecraft:item_display,tag=glbs_item_highlight] run function global_shop:logic/item_display_entity/redisplay_text
