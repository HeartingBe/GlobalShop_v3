data modify storage global_shop:common player.SelectedItem.tag.global_shop set from storage global_shop:storage g_cashInfo[1].item.tag.global_shop
...
data modify storage global_shop:storage g_cashInfo[1].item set from storage global_shop:common player.SelectedItem
