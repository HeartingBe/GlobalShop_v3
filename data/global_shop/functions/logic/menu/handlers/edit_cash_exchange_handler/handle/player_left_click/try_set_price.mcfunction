...
tellraw @s [{"text":"点击这里来设置货币的面值","color":"green","bold": true,"clickEvent":{"action":"suggest_command","value": "/trigger glbs_inputter_1 set ?"},"hoverEvent":{"action":"show_text","contents":["\u00a7a请将 ? 更改为你想要的面值"]}}]