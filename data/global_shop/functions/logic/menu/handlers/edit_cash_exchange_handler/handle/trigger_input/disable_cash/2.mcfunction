...
data modify entity @e[distance=..5,type=item_display,scores={glbs_order=13},limit=1] item set from storage global_shop:menu_preset_and_control CONTROL_DISABLED_CASH