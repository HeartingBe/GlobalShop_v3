...
execute on vehicle on passengers if entity @s[scores={glbs_order=13},type=minecraft:item_display,tag=!glbs_killed] run data modify entity @s item set from storage global_shop:menu_preset_and_control CONTROL_DISABLED_CASH
