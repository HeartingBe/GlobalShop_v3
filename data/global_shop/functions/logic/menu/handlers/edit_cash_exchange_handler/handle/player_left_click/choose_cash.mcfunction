...
# 使左键的货币高亮，使之前左键的货币不亮
    ...
    execute on passengers if entity @s[type=minecraft:item_display] run function global_shop:logic/menu/handlers/edit_cash_exchange_handler/handle/player_left_click/choose_cash/set_state
# 记录物品order供点击按钮的时候使用
