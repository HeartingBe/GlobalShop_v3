...
# 高亮物品展示实体，并显示文本
   # 高亮，并记录看向物品的 id
   execute as @e[distance=..5,type=minecraft:item_display,tag=global_shop] run function global_shop:logic/menu/handlers/edit_cash_exchange_handler/highlight_item_and_display_text
