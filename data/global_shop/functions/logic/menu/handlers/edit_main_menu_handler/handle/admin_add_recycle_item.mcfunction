...
# 主手是货币
execute if data entity @s SelectedItem.tag.global_shop.price run return run function global_shop:logic/menu/handlers/edit_main_menu_handler/handle/admin_add_recycle_item/hold_cash
...
# 检查通过：
   ...
   # 通知
   tellraw @s [{"type":"nbt","storage":"global_shop:storage","nbt":"TELLRAW_PREFIX","interpret":true},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"recycle_shop.set_success\"","color":"green"}]
