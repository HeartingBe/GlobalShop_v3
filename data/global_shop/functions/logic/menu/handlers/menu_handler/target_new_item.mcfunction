...
# 高亮物品展示实体，并显示文本
   # 高亮，并记录看向物品的 id
   execute on passengers if entity @s[type=minecraft:item_display,tag=!glbs_killed] run function global_shop:logic/menu/handlers/menu_handler/highlight_item_and_display_text
