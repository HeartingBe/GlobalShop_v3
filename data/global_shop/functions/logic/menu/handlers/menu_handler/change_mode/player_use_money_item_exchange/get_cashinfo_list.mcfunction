#> global_shop:logic/menu/handlers/menu_handler/change_mode/player_use_money_item_exchange/get_cashinfo_list
# 读取现金货币信息的列表

data modify storage global_shop:common g_itemsToDisplay set from storage global_shop:menu_preset_and_control player_use_money_item_exchange
