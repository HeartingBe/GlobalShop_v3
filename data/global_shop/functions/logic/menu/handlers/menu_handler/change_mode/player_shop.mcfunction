...
# 通知玩家，并给 inputter_1 和 inputter_2 权限（用于跳转）
execute on passengers if entity @s[type=minecraft:player] run function global_shop:logic/menu/handlers/menu_handler/change_mode/player_shop/title_and_enable
# 生成物品展示实体
