#> global_shop:logic/menu/handlers/editmode_menu_handler/handle/player_sell_item
# @brief 上架玩家主手的物品
# @executor Player

# 输入是负数
execute if score @s glbs_sell_item_price matches ..0 run return run function global_shop:logic/menu/handlers/editmode_menu_handler/handle/player_sell_item/invalid_num

# 主手为空
execute unless data entity @s SelectedItem run return run function global_shop:logic/menu/handlers/editmode_menu_handler/handle/player_sell_item/main_hand_has_no_item
