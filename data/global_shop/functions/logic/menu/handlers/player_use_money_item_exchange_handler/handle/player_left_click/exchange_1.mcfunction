...
data modify storage global_shop:common g_itemData set from storage global_shop:storage g_cashInfo[1].item
    ...
    data modify entity 00000d3a-0000-0d3a-0000-17cc0000edfa text set value '[{"text":"货币价值：","color":"gold","italic":false},{"nbt":"g_cashInfo[1].item.tag.global_shop.price","storage":"global_shop:storage","color":"aqua"}]'
