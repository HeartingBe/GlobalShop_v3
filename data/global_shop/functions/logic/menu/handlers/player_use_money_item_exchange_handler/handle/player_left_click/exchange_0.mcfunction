#> global_shop:logic/menu/handlers/player_use_money_item_exchange_handler/handle/player_left_click/exchange_0
# @executor player

# 是否被禁用
execute if data storage global_shop:storage g_cashInfo[0].disable run return run function global_shop:logic/menu/handlers/player_use_money_item_exchange_handler/handle/player_left_click/exchange_n/cash_disabled
