...
data modify storage global_shop:common g_itemData set from storage global_shop:storage g_cashInfo[3].item
    ...
    data modify entity 00000d3a-0000-0d3a-0000-17cc0000edfa text set value '[{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.item_frame.cash_value","color":"yellow"},{"text":": ","color":"yellow},{"nbt":"g_cashInfo[3].item.tag.global_shop.price","storage":"global_shop:storage","color":"aqua"}]'
