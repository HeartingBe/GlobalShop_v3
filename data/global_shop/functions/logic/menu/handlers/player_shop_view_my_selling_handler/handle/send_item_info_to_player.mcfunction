...
function global_shop:logic/menu/handlers/player_shop_view_my_selling_handler/handle/send_item_info_to_player/tellraw_myself with storage global_shop:common temp.itemInfo
