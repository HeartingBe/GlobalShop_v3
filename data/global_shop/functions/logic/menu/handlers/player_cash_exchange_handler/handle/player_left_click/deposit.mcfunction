...
# 输出玩家现在钱的数量
tellraw @s [{"type":"nbt","storage":"global_shop:storage","nbt":"TELLRAW_PREFIX","interpret":true},{"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"cash.exchange.save_success\"","color":"aqua"},{"score":{"name":"playerMoney","objective":"glbs_common"},"color":"yellow"}]
