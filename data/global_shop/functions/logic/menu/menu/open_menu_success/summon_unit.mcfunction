...
execute as @e[distance=..2,type=minecraft:block_display,tag=glbs_temp] run function global_shop:logic/menu/menu/open_menu_success/carry_player_and_set_data
