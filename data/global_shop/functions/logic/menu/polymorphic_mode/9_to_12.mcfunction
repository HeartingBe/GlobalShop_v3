#> global_shop:logic/menu/polymorphic_mode/9_to_12
...
# 编辑货币交换的处理逻辑 12
execute if score @s glbs_mode = Mode::EDIT_CASH_EXCHANGE glbs_common run return run function global_shop:logic/menu/handlers/edit_cash_exchange_handler/handle