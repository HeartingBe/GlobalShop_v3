...
# transformation 变换
   # scale 以原点为中心缩放模型
data merge entity @s {billboard:"center",alignment:"left",background:-283703273,see_through:false,brightness:{block:15,sky:15},transformation:{scale:[0.75f,0.75f,0.75f]}}
