...
# transformation 变换
   # scale 以原点为中心缩放模型
   # translation 平移变换
data merge entity @s {billboard:"center",alignment:"left",background:-283703273,see_through:false,line_width:144,brightness:{block:15,sky:15},transformation:{scale:[0.6f,0.6f,0.6f],translation:[1.2f,-1.0f,0.0f]}}
