...
# 显示
   # 如果没有文本展示实体，需要先生成
   function global_shop:logic/item_display_entity/display_count/check_text_display
execute on passengers run data merge entity @s {text_opacity:-1b,text:'{"score":{"objective":"glbs_common","name":"Count"}}'}