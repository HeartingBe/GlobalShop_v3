#> global_shop:logic/item_data/polymorphic_type/4_to_7
...
# 玩家历史出售的物品 5
execute if score temp2 glbs_common = ItemDataType::MY_SOLD glbs_common run return run function global_shop:logic/item_data/my_sold_item_data/to_string
# 退回的物品 6
