...
# 写入价格
   ...
   function global_shop:logic/item_data/add_seperator
   # 文字和 id
   data modify storage global_shop:common g_text append value {"type":"nbt","storage":"global_shop:storage","nbt":"g_lang.\"item_frame.recycle_price\"","color":"white","extra":[{"text":": ","color":"white"},{"storage":"global_shop:common","nbt":"g_itemData.tag.global_shop.price","color":"yellow"}]}
