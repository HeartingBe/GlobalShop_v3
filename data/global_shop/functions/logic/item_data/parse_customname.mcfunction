...
data modify storage global_shop:common g_text append value {"text":"","extra":[{"storage":"global_shop:common","nbt":"g_itemIdTranslateJson","interpret":1},{"text":" "},{"storage":"global_shop:common","nbt":"g_itemData.tag.display.Name","interpret":1}]}