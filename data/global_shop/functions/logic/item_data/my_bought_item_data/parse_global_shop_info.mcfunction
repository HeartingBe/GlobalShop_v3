...
# 写入出售玩家
   ...
   # 写入玩家名
   data modify storage global_shop:common g_text append value {"type":"nbt","storage":"global_shop:storage","nbt":"\"g_lang.item_frame.seller\"","color":"white","extra":[{"text":": ","color":"white"},{"storage":"global_shop:common","nbt":"g_playerName","color":"yellow"}]}