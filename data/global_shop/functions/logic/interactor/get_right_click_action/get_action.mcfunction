...
execute store result score temp2 glbs_common run data get entity @s interaction.player[1]
execute store result score temp3 glbs_common run data get entity @s interaction.player[2]
execute store result score temp4 glbs_common run data get entity @s interaction.player[3]
